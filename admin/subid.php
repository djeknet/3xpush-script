                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="CTR">CTR</th>
                                            <th title="CPM">CPM</th>
                                            <th title="<?php echo _CLICKPRICETITLE ?>"><?php echo _CLICKPRICE ?></th>
                                    ...
                                    <?php
                                     ...
                                     $all=array();
                                      ...
                                      foreach ($stat as $subid => $value) {
                                      	...
                                      	if ($value['money']>0) $clickprice = round($value['money'] / $value['clicks'], 2); else $clickprice=0;
                                      ...
                                      if ($stat['ALL']['uniq_sended']>0) $usersended = round($stat['ALL']['sended'] / $stat['ALL']['uniq_sended'], 1); else $usersended=0;
                                      ...
                                      if ($stat['ALL']['money']>0 && $stat['ALL']['clicks']>0) $clickprice = round($stat['ALL']['money'] / $stat['ALL']['clicks'], 2); else $clickprice=0;
