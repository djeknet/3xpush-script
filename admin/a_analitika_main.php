...
<form name="filters" action="index.php" method="get" id="searchform" class="form-horizontal">
                             ...
                             <div class="row form-group">
                              <div class="col col-md-2"><?php echo _DATE; echo " "._FROM ?> <input type="text" name="start_date" id='datepicker' value="<?php echo $start_date ?>"  class="form-control form-control-sm"></div>
                                 ...
                                 <input name="m" type="hidden" value="<?php echo $module ?>">
                                  ...
                                  <a href="?m=<?php echo $module ?>" class="btn btn-danger btn-sm"><i class="fa fa-ban"></i> <?php echo _RESET ?></a> <br />
                             </form>
  ...
  <script type="text/javascript">
                                    ...
                                    function load_all_stats() {
                                        ...
                                        var items = ["all", "sites", "users", "payment"];
                                        ...
                                        function ajax_load_stat_data(index) {
                                            ...
                                            $.ajax({
                                                url: 'ajax/sysstat.php?' + params + '&type=' + type,
                                                beforeSend: function () {
                                                },
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title"><?php echo _COMMON_STAT; ?></strong>
                                        </div>
                                        <div class="card-body">
                                            <div id="all"></div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title"><?php echo _SITESSTAT; ?></strong>
                                        </div>
                                        <div class="card-body">
                                            <div id="sites"></div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title"><?php echo _BY_USERS; ?></strong>
                                        </div>
                                        <div class="card-body">
                                            <div id="users"></div>
                                        </div>
